...
function hackeryou_scripts() {
  ...
  wp_enqueue_script(
  	'jquery',
  	"http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://code.jquery.com/jquery-3.3.1.min.js",
  	false, //dependencies
  	null, //version number
  	true //load in footer
  );
...
/* hackeryou_featured_image_url - return the url for a featured image to be used in <img> tags */
